...
server<-function(input,output){
  ...
  M1<-reactive({
    ####### main endpoint
    mean1=c(dGU=-0.1595,`gammaGU[1]`=-0.0881,`gammaGU[2]`=0.0041,`gammaGU[3]`=0.0123,`gammaGU[4]`=0.018,`gammaGU[5]`=0.012,`gammaGU[6]`=0.0198,`gammaGU[7]`=-0.0225)
    var1=structure(c(0.0054,0.00021,-9e-05,-1e-05,-3e-05,-0.00013,-0.00012,1e-05,0.00021,0.00192,9e-05,4e-05,3e-05,-2e-05,-3e-05,-5e-05,-9e-05,9e-05,0.00133,-0.00012,-0.00012,-0.00017,
    ...
    mean2=c(`d[1]`=-0.3693,`gamma[1,1]`=-0.1106,`gamma[1,2]`=-0.0107,`gamma[1,3]`=-1e-04,`gamma[1,4]`=0.0125,`gamma[1,5]`=0.0067,`gamma[1,6]`=0.0065,`gamma[1,7]`=-0.022)
    var2=structure(c(0.0057,5e-04,0,-1e-04,0,-1e-04,0,1e-04,5e-04,0.0022,1e-04,0,0,0,0,0,0,1e-04,9e-04,0,-1e-04,-1e-04,1e-04,0,-1e-04,0,0,6e-04,0,0,0,0,0,0,-1e-04,0,6e-04,
    ...
    mean3=c(`d[3]`=-0.2098,`gamma[3,1]`=-0.02248,`gamma[3,2]`=-0.01476,`gamma[3,3]`=-0.01242,`gamma[3,4]`=-0.0055,`gamma[3,5]`=-0.00532,`gamma[3,6]`=-0.01333,`gamma[3,7]`=0.00049)
    var3=structure(c(0.004379,0.000149,-2.9e-05,3e-06,-3.5e-05,-2.7e-05,4.7e-05,-5.4e-05,0.000149,0.000893,6.1e-05,4.2e-05,2.3e-05,1.6e-05,6.2e-05,-3.1e-05,-2.9e-05,6.1e-05,0.000688,-2.8e-05,
    ...
    M1=(patient%*%mean1)*5
    SE1=sqrt(patient%*%var1%*%patient)*5
    
    M2=(patient%*%mean2)*5
    SE2=sqrt(patient%*%var2%*%patient)*5
    
    M3=(patient%*%mean3)*5
    SE3=sqrt(patient%*%var3%*%patient)*5
  ...
  M_6months<-reactive({
   mean1=c(dGU=0.004,`gammaGU[1]`=-0.0097,`gammaGU[2]`=-0.0185,`gammaGU[3]`=0.0457,`gammaGU[4]`=-0.0531,`gammaGU[5]`=-0.0279,`gammaGU[6]`=0.0109,`gammaGU[7]`=-0.0292)
var1=structure(c(0.010378,0.001186,-0.000393,3.4e-05,-0.000323,0.000133,7.1e-05,0.000178,0.001186,0.002573,-2.6e-05,5.9e-05,
...
mean2=c(`d[1]`=-0.2521,`gamma[1,1]`=-0.0248,`gamma[1,2]`=-0.0017,`gamma[1,3]`=0.0141,`gamma[1,4]`=-0.0081,`gamma[1,5]`=-0.022,`gamma[1,6]`=0.0026,`gamma[1,7]`=-0.0382)
var2=structure(c(0.008097,0.000771,-0.000207,-0.000165,-7.6e-05,0.000192,0.000139,0.000216,0.000771,0.001776,1.3e-05,-5.6e-05,
...
mean3=c(`d[2]`=-0.2562,`gamma[2,1]`=-0.0151,`gamma[2,2]`=0.0168,`gamma[2,3]`=-0.0316,`gamma[2,4]`=0.0451,`gamma[2,5]`=0.0059,`gamma[2,6]`=-0.0083,`gamma[2,7]`=-0.0089)

var3=structure(c(0.006462,0.000529,-0.000164,-2.8e-05,-0.00022,3.9e-05,-8e-05,-0.000155,0.000529,0.00127,-3.9e-05,0.000103,-7.7e-05,-1.2e-05,5.1e-05,-2.1e-05,-0.000164,-3.9e-05,0.001028,-0.000149,-3e-05,-7.3e-05,8.1e-05,-3.1e-05,-2.8e-05,0.000103,-0.000149,0.001241,-0.000164,-4.8e-05,0.000112,4.1e-05,-0.00022,-7.7e-05,-3e-05,-0.000164,0.001422,4e-05,-2.5e-05,-6.9e-05,3.9e-05,-1.2e-05,-7.3e-05,-4.8e-05,4e-05,0.001094,-3.7e-05,5.2e-05,-8e-05,5.1e-05,8.1e-05,0.000112,-2.5e-05,-3.7e-05,0.001153,3e-05,-0.000155,-2.1e-05,-3.1e-05,4.1e-05,-6.9e-05,5.2e-05,3e-05,0.000904),.Dim=c(8L,8L),.Dimnames=list(c("d[2]","gamma[2,1]","gamma[2,2]","gamma[2,3]","gamma[2,4]","gamma[2,5]","gamma[2,6]","gamma[2,7]"),c("d[2]","gamma[2,1]","gamma[2,2]","gamma[2,3]","gamma[2,4]","gamma[2,5]","gamma[2,6]","gamma[2,7]")))
  ...
  M_12months<-reactive({
mean1=c(dGU=-0.0137,`gammaGU[1]`=-0.0164,`gammaGU[2]`=0.0095,
`gammaGU[3]`=-0.0064,`gammaGU[4]`=-0.0099,`gammaGU[5]`=-0.0208,
`gammaGU[6]`=0.0103,`gammaGU[7]`=0.0042)
var1=structure(c(0.013901,0.00028,-0.00035,-7e-06,-0.000297,-0.000286,
...
mean2=c(`d[1]`=-0.2099,`gamma[1,1]`=-0.0132,`gamma[1,2]`=-0.0026,
`gamma[1,3]`=0.0075,`gamma[1,4]`=0.0021,`gamma[1,5]`=-0.0393,
`gamma[1,6]`=0.0034,`gamma[1,7]`=7e-04)
var2=structure(c(0.017376,0.000421,-0.000295,-0.000108,-0.000338,
...
mean3=c(`d[3]`=-0.1962,`gamma[3,1]`=0.0032,`gamma[3,2]`=-0.0121,
`gamma[3,3]`=0.0139,`gamma[3,4]`=0.0119,`gamma[3,5]`=-0.0185,
`gamma[3,6]`=-0.0069,`gamma[3,7]`=-0.0036)
var3=structure(c(0.010275,4.3e-05,-0.00011,-6.5e-05,-0.000176,
...
age=(as.numeric(input$age)-41)/12
  ...
  output$text12<-renderText({
    paste("<i>","<font size = 3>","<br>","An estimate smaller than zero in the comparison of A vs. B favors treatment A. An estimate larger than zero favors treatment B.")
  })
